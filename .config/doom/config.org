...
#+AUTHOR: Jaime Pereira (JPszC)
#+DESCRIPTION: JP's personal Doom Emacs config.
...
#+RESULTS:
| doom--customize-themes-h-8 | doom--customize-themes-h-9 | doom--customize-themes-h-10 | doom--customize-themes-h-11 |
